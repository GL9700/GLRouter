...
Pod::Spec.new do |s|
  s.name             = 'GLRouter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of GLRouter.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/liandyii@msn.com/GLRouter'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'liandyii@msn.com' => 'guoliang@51jianjiao.com' }
  s.source           = { :git => 'https://github.com/liandyii@msn.com/GLRouter.git', :tag => s.version.to_s }
